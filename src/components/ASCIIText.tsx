...
// Math.map polyfill
const mathMap = (n: number, start: number, stop: number, start2: number, stop2: number): number => {
        ...
        >
            <style>{`
                ...
                .ascii-text-container pre {
                    ...
                    left: 0;
                    top: 0;
                    background-image: radial-gradient(circle, #a855f7 0%, #06b6d4 50%, #f472b6 100%);
