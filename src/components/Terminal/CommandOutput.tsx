        ...
        return (
            <div className="mb-4 font-mono text-[13px]">
                ...
                <div className="text-[#e5e7eb] ml-2">
                    <a href="https://github.com/GratiaManullang03" target="_blank" rel="noreferrer" className="flex items-center gap-3 mb-3 group">
                        <svg className="w-5 h-5 text-[#a855f7] group-hover:text-[#f472b6] transition-colors" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <span className="text-[#06b6d4] group-hover:text-[#f472b6] transition-colors">github.com/GratiaManullang03</span>
                    </a>
                    <a href="https://linkedin.com/in/graxya" target="_blank" rel="noreferrer" className="flex items-center gap-3 mb-3 group">
                        <svg className="w-5 h-5 text-[#a855f7] group-hover:text-[#f472b6] transition-colors" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                        </svg>
                        <span className="text-[#06b6d4] group-hover:text-[#f472b6] transition-colors">linkedin.com/in/graxya</span>
                    </a>
                    <a href="https://instagram.com/graxya_" target="_blank" rel="noreferrer" className="flex items-center gap-3 mb-3 group">
                        <svg className="w-5 h-5 text-[#a855f7] group-hover:text-[#f472b6] transition-colors" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <span className="text-[#06b6d4] group-hover:text-[#f472b6] transition-colors">@graxya_</span>
                    </a>
                    <a href="mailto:gratiamanullang03@gmail.com" className="flex items-center gap-3 mb-3 group">
                        <svg className="w-5 h-5 text-[#a855f7] group-hover:text-[#f472b6] transition-colors" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                            <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/>
                            <polyline points="22,6 12,13 2,6"/>
                        </svg>
                        <span className="text-[#06b6d4] group-hover:text-[#f472b6] transition-colors">gratiamanullang03@gmail.com</span>
                    </a>
                    <a href="https://graxya.is-a.dev" target="_blank" rel="noreferrer" className="flex items-center gap-3 group">
                        <svg className="w-5 h-5 text-[#a855f7] group-hover:text-[#f472b6] transition-colors" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                            <circle cx="12" cy="12" r="10"/>
                            <line x1="2" y1="12" x2="22" y2="12"/>
                            <path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/>
                        </svg>
                        <span className="text-[#06b6d4] group-hover:text-[#f472b6] transition-colors">graxya.is-a.dev</span>
                    </a>
                </div>
        ...
        return (
            <div className="mb-4 font-mono text-[13px]">
                ...
                <div className="text-[#e5e7eb] mb-4">
                    <div className="mb-3">
                        <span className="text-[#a855f7]">Name:</span> Felix Gratia Mangatur Manullang
                    </div>
                    <div className="mb-3">
                    ...
                    <div className="mb-3">
                        <span className="text-[#a855f7]">Location:</span> Tangerang, Indonesia
                    </div>
                </div>
                ...
                <div className="text-[#e5e7eb] mb-4 leading-relaxed">
                    <p className="mb-2">
                        Ambitious student at Polytechnic Multimedia Nusantara with a <span className="text-[#22c55e]">3.93 GPA</span>,
                        passionate about building scalable backend systems and exploring the intersection
                        of technology with logistics and business.
                    </p>
                    <p className="mb-2">
                        Experienced in <span className="text-[#06b6d4]">FastAPI</span>, <span className="text-[#06b6d4]">Laravel</span>,
                        <span className="text-[#06b6d4]"> React</span>, and <span className="text-[#06b6d4]">Flutter</span>.
                        Currently interning at <span className="text-[#f472b6]">Alfagift</span>, developing internal web applications
                        with clean architecture principles.
                    </p>
                    <p>
                        Former President of E-Commerce Logistics Student Association, event organizer,
                        and national competition participant. Always learning, always building.
                    </p>
                </div>

                <div className="text-[#6b7280] text-[11px]">
                    Type <span className="text-[#06b6d4]">/social</span> to see my contact info.
                </div>
            </div>
        );
    }
